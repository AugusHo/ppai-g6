...
namespace PantallaImportarActualizacion.Datos
{
    public static class InterfazAPIBodega
    {
        public static List<Entidades.Vino> ObtenerActualizaciones()
        {
            ...
            vinosConActualizacion.Add(new Entidades.Vino("2018", "imagen100.jpg", "Vino Tinto Reserva", 4, 1234.5f, bodegas[0], new List<Entidades.Maridaje> { maridajes[2], maridajes[5] }, "no se actualizo", new List<Entidades.Varietal> { varietales[0], varietales[1] }));
            ...
            //Vinos para crear
            vinosConActualizacion.Add(new Entidades.Vino("2009", "imagen200.jpg", "Vino Blanco Toro", 3, 5678.9f, bodegas[0], new List<Entidades.Maridaje> { maridajes[2], maridajes[3] }, "no se actualizo", new List<Entidades.Varietal> { varietalesNuevos[0], varietalesNuevos[1] }));
