...
namespace PantallaImportarActualizacion.Datos
{
    public static class BodegaFactory
    {
        public static List<Entidades.Bodega> DatosBodegas()
        {
            ...
            bodegas.Add(new Entidades.Bodega("VLLC", "Bodega 4", "Zuccardi", true, 2151565));
            bodegas.Add(new Entidades.Bodega("PPQGS", "Bodega 5", "Andeluna", true, 2151565));
            bodegas.Add(new Entidades.Bodega("OA", "Bodega 6", "Rutini", true, 2151565));
            bodegas.Add(new Entidades.Bodega("AJKDJAS", "Bodega 7", "Colomé", true, 2151565));
            bodegas.Add(new Entidades.Bodega("EA", "Bodega 8", "Luigi Bosca", true, 2151565));
            return bodegas;
        }
    }
}
